...
| ------ | --------- | ------ |
| [`copilot-memory`](./plugins/copilot-memory) · [página](https://allansantos-dv.github.io/copilot-marketplace/p/copilot-memory/) | Memória persistente por projeto para o Copilot (pt-BR): guarda decisões, conhecimento e lições e as recupera por busca semântica, isoladas no projeto certo, com recall automático no contexto. Um curador destila os aprendizados da sessão em skills reutilizáveis, e um grafo semântico do código — símbolos, chamadas, imports — ajuda a navegar repositórios grandes sem garimpar arquivo por arquivo. Sobe um daemon local sozinho, com painel de saúde, escopo e skills. | 1.14.0 |

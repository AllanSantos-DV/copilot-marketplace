...
export const CURRENT_VERSION = "2.3.8";
...
const UPDATABLE_FILES = new Set(["extension.mjs", "voice-shared.cjs", "voice-core.mjs", "voice-python.mjs", "voice-update.mjs", "voice-text.mjs", "voice-state.mjs", "voice-audio.mjs", "voice-worker.mjs", "voice-net.mjs", "voice_worker.py", "vox_sdk.py", "vox_cli.py", "voice-engine-bootstrap.mjs", "capture_port.py", "capture_session.py", "vox_capture_adapter.py", "iframe.html", "requirements.txt", "voice-summary-stop.neural-link.json", "voice-canvas-guard.neural-link.json", "voice-summary-stop.cjs", "voice-canvas-guard.cjs"]);
